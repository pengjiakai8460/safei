...
class WapTemplate
{
    ...
    function es_tmpl($out)
    {
    	 //对图片路径的修复
	        ...
	        $out = str_replace("./images/",  $domain."/tpl/".TMPL_NAME."/images/", $out);
	        $out = str_replace("./css/",  $domain."/tpl/".TMPL_NAME."/css/", $out);
	        $out = str_replace("./flash/",  $domain."/tpl/".TMPL_NAME."/flash/", $out);
	        $out = str_replace("./js/",  $domain."/tpl/".TMPL_NAME."/js/", $out);
	        $out = str_replace("./xml/",  $domain."/tpl/".TMPL_NAME."/xml/", $out);
