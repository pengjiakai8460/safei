...
<style type="text/css">
	...
	.colors{color: #fff;}
	.black{color:black;}
	.image-login{position: absolute;top:0.5em;left:75%;background-color: red;height: 2.5em;width: 20%;text-align: center;line-height: 2.5em;border-radius: 1em;background-color: #B3B9C6;color: #fff;background: rgba(0,0,0,0.1);z-index: 8888888888888;}
...
<!-- 上部标题 -->
<div class="top-tips">
	<span class="top-tips-left black"><img src="./images/a1.png">&nbsp;<a href="#" onclick="RouterURL('<?php
echo parse_wap_url_tag("u:index|show_article|"."id=43".""); 
?>','#show_article',2);"> 上海萨飞投资管理有限公司开业活动公告</a></span>
	<!-- 此处链接未填写 -->
	<span class="top-tips-right"><a href="#" onclick="RouterURL('<?php
echo parse_wap_url_tag("u:index|article_list|"."epage=".$this->_var['data']['act']."".""); 
?>','#article_list',2);" class="colors">更多&nbsp;></a></span>
</div>
<hr>
<!--头部 en-->
<!--///中部///-->
<div class="new-box">
	...
	<div class="new-box-sm">
		...
		<span><a href="http://www.safeionline.com/wap/tpl/yincunhtml/" external>银行存管</a></span>
	</div>
	<div class="new-box-sm">
...
<div class="total-msg">
	<div>
		...
		<div class="total-msg-nums">
			<?php echo $this->_var['data']['virtual_money_1']; ?>
		</div>
	</div>
	<div>
		<div class="total-msg-title">
		...
		<div class="total-msg-nums">
			<?php echo $this->_var['data']['virtual_money_2']; ?>
		</div>
	</div>
	<div>
		<div class="total-msg-title">
		...
		<div class="total-msg-nums">
			<?php echo $this->_var['data']['virtual_money_3']; ?>
		</div>
	</div>
</div>
...
?>','#deal',2);">
					...
					<div class="title_nav bb1" style="padding-top: 0.5em;">
						...
						<?php if ($this->_var['deal']['is_wait'] == 1): ?><span class="state  c666666">
							...
							<?php if ($this->_var['deal']['deal_status'] == 1 && $this->_var['deal']['remain_time'] > 0): ?><span class="state  c56b1ea" style="padding-top: 0.5em;"><?php endif; ?>
							<?php if ($this->_var['deal']['deal_status'] == 1 && $this->_var['deal']['remain_time'] <= 0): ?><span class="state  c666666" style="margin-top: 0.5em;"><?php endif; ?>
...
?>万</i><i class="unit"></i><p style="color:#999999;font-size: 0.8em;">剩余可购</p></div>
						<div  class="progress-radial_parent" style="margin-left: 30%;">
