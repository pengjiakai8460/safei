...
class Ems_express implements express {
	...
	public function get_express_form($order_id,$express_sn)
	{
		...
		$order_info['region_lv1_name'] = $GLOBALS['db']->getOne("select name from ".DB_PREFIX."region_conf where id = ".intval($order_info['region_lv1']));
		$order_info['region_lv2_name'] = $GLOBALS['db']->getOne("select name from ".DB_PREFIX."region_conf where id = ".intval($order_info['region_lv2']));
		$order_info['region_lv3_name'] = $GLOBALS['db']->getOne("select name from ".DB_PREFIX."region_conf where id = ".intval($order_info['region_lv3']));
		$order_info['region_lv4_name'] = $GLOBALS['db']->getOne("select name from ".DB_PREFIX."region_conf where id = ".intval($order_info['region_lv4']));
