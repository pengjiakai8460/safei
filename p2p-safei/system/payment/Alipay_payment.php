...
class Alipay_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$payLinks = '<a href="https://mapi.alipay.com/gateway.do?'.$param. '&sign='.$sign_md5.'&sign_type=MD5" target="_blank" ><span class="paybutton" name="buy">前往支付宝在线支付</span></a>';

    	if(!empty($payment_info['logo']))
		{
			$payLinks = '<a href="https://mapi.alipay.com/gateway.do?'.$param. '&sign='.$sign_md5.'&sign_type=MD5" target="_blank" class="payLink"><img src='.APP_ROOT.$payment_info['logo'].' style="border:solid 1px #ccc;" /></a><div class="blank"></div>'.$payLinks;
		}
	...
	//public function auto_do_deal_repay($payment_notice,$order_info,$need_user = 1)
	//{
