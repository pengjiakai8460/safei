...
class Baofoo_payment implements payment {
	...
	public function get_payment_code($payment_notice_id) {
        ...
        $post_url = "https://gw.baofoo.com/payindex";
        if($_MerchantID=="100000178"){
            $post_url = "https://vgw.baofoo.com/payindex";
        }
         
        $def_url = '<form style="text-align:center;" action="'.$post_url.'" target="_blank" style="margin:0px;padding:0px" method="POST" >';
