<?php
	...
	function DoDwTrade($user_id,$platformNo,$pTrdAmt,$post_url){
		...
		<form style="display:none;" name="form1" id="form1" method="post" action="'.$post_url.'/bha/toWithdraw" target="_self">		
	...
	function DoDwTradeCallBack($str3Req){
		...
		if ($str3Req["code"] == "1" && $GLOBALS['db']->affected_rows()){	
			...
			//操作成功
			$GLOBALS['db']->autoExecute(DB_PREFIX."yeepay_withdraw",$result,'UPDATE',$where);	
		}
		return 1;
	}	
