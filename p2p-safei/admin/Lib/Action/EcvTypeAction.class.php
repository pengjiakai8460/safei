		...
		switch($send_type)
		{
			case 0:
				...
				if($user_list)
				{
					...
					$this->assign("jumpUrl",u("EcvType/doSend",array("ecv_type_id"=>$ecv_type_id,'need_password'=>$need_password,'send_type'=>$send_type,'user_level'=>$user_level,'user_id'=>$user_ids,'gen_count'=>$gen_count,'page'=>($page+1))));
