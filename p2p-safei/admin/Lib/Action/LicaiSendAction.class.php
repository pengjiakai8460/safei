...
class LicaiSendAction extends CommonAction{
	...
	{	
		...
		foreach($result['list']  as $k => $v)
		{
			...
			else
			{
				...
				$result["list"][$k]['interest_money_format']= format_price($v["money"]*$licai_interest["interest_rate"]/365/100); 
			}
		}
	...
	{	
		...
		foreach($list  as $k => $v)
		{
			...
			else
			{
				...
				$list[$k]['interest_money_format']= format_price($v["money"]*$licai_interest["interest_rate"]/365/100); 
			} 
		}
	...
	public function view()
	{
		...
		$vo["back_money_format"] = format_price($vo["back_money"]);
