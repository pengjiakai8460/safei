...
class CreditAction extends CommonAction{
	...
	private function user_get_list($status = -1){
		...
		if(strim($_REQUEST["type"])!="")
		{
			$map['type'] = array("eq",strim($_REQUEST["type"]));
		}
