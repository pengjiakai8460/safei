...
class LicaiInterestAction extends CommonAction{
	...
	{	
		...
		{
			$result['list'][$k]["min_money_format"] = format_price($v['min_money']);
			$result['list'][$k]["max_money_format"] = format_price($v['max_money']);
			$result['list'][$k]["interest_rate_format"] = number_format($v['interest_rate'],2)."%";
			$result['list'][$k]["buy_fee_rate_format"] = number_format($v['buy_fee_rate'],2)."%";
			$result['list'][$k]["site_buy_fee_rate_format"] = number_format($v['site_buy_fee_rate'],2)."%";
			$result['list'][$k]["redemption_fee_rate_format"] = number_format($v['redemption_fee_rate'],2)."%";
			$result['list'][$k]["before_rate_format"] = number_format($v['before_rate'],2)."%";
			$result['list'][$k]["before_breach_rate_format"] = number_format($v['before_breach_rate'],2)."%";
			$result['list'][$k]["breach_rate_format"] = number_format($v['breach_rate'],2)."%";
			$result['list'][$k]["platform_rate_format"] = number_format($v['platform_rate'],2)."%";
			$result['list'][$k]["freeze_bond_rate_format"] = number_format($v['freeze_bond_rate'],2)."%";
			$result['list'][$k]["platform_breach_rate_format"] = number_format($v['platform_breach_rate'],2)."%";
