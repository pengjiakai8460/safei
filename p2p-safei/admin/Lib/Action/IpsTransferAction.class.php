...
class IpsTransferAction extends CommonAction{
	public function index()
	{
		...
		if(strtolower($className) == "ips")
		{
			...
			$sql = "select dlt.id as mid,t.*,d.`name`,u.user_name,tu.user_name as t_user_name,dlt.user_id,dlt.t_user_id,(dlt.load_money - dlt.transfer_amount) as leave_money from ".DB_PREFIX."ips_transfer as t
		...
		elseif(strtolower($className) == "yeepay")
		{
			...
			$sql = "select dlt.id as mid,t.*,d.`name`,u.user_name,tu.user_name as t_user_name,dlt.user_id,dlt.t_user_id,dlt.ips_status,dlt.t_user_id ,
