...
class Page  {
    ...
    public function __construct($totalRows,$listRows,$parameter='') {
        ...
        $this->rollPage = 5;
        $this->listRows = !empty($listRows)?$listRows:app_conf('PAGE_SIZE');
   ...
   private function get_page_link($url,$page)
    ...
    public function show() {
        ...
        if($nowCoolPage == 1){
            ...
            $prePage = "<a href='".$this->get_page_link($url,$preRow)."'  class='ProllPage'>上".$this->rollPage."页</a>";
        ...
        if($nowCoolPage == $this->coolPages){
            ...
            $nextPage = "<a href='".$this->get_page_link($url,$nextRow)."' class='NrollPage'>下".$this->rollPage."页</a>";
