...
class Bfwap_payment implements payment {	
	...
	public function get_payment_code($payment_notice_id) {
        ...
        $url = SITE_DOMAIN.APP_ROOT.'/callback/pay/bfwap_pay.php?payment_notice_id='.$payment_notice_id;
	...
	public function get_payment($payment_notice_id) {
       ...
       // $_Return_url = SITE_DOMAIN.APP_ROOT.'/baofoo_callback.php?act=notify';
        ...
        $_Merchant_url = str_replace(array("/mapi","/callback/pay/callback/pay/"), array("","/callback/pay/"), $_Merchant_url);
        $_Return_url = str_replace(array("/mapi","/callback/pay/callback/pay/"), array("","/callback/pay/"), $_Return_url);
        ...
        */
		...
		if ($payment_info['config']['baofoo_account'] == '100000178'){
			$url = 'https://tgw.baofoo.com/wapmobile?'.http_build_query($parameter);
		}else{
