...
//	$log_->log_result($log_name,print_r($GLOBALS['HTTP_RAW_POST_DATA'],true));
	...
	$notify->update_config($wx_config['appid'],$wx_config['appsecret'],$wx_config['mchid'],$wx_config['partnerid'],$wx_config['partnerkey'],$wx_config['key'],$wx_config['sslcert'],$wx_config['sslkey']);
 	...
 	if($order_id==""&&$payment_notice_sn==""){
 		 
		//进入V3
		//存储微信的回调
		
 		$xml = $GLOBALS['HTTP_RAW_POST_DATA'];
// 		$xml='<xml><appid><![CDATA[wxb98af717fd2a5ba5]]></appid>
//<bank_type><![CDATA[CFT]]></bank_type>
//<cash_fee><![CDATA[1]]></cash_fee>
//<fee_type><![CDATA[CNY]]></fee_type>
//<is_subscribe><![CDATA[Y]]></is_subscribe>
//<mch_id><![CDATA[1240545402]]></mch_id>
//<nonce_str><![CDATA[cwn9sacpcoor6yrbhz9o0fibbu8v2q4q]]></nonce_str>
//<openid><![CDATA[of2HnspIgnZwL-7c8RXl3iOsnxIg]]></openid>
//<order_id><![CDATA[0]]></order_id>
//<out_trade_no><![CDATA[20150520065309225]]></out_trade_no>
//<result_code><![CDATA[SUCCESS]]></result_code>
//<return_code><![CDATA[SUCCESS]]></return_code>
//<sign><![CDATA[41E8C74140AFFC233DEA9BE0DD50A3E2]]></sign>
//<time_end><![CDATA[20150520185318]]></time_end>
//<total_fee>1</total_fee>
//<trade_type><![CDATA[JSAPI]]></trade_type>
//<transaction_id><![CDATA[1008630979201505200146261624]]></transaction_id>
//</xml>';	
 		$notify->saveData($xml);
  		if($notify->checkSign() == FALSE){
  			var_dump($notify->checkSign());
			...
			$payment_notice_id=$payment_notice['id'];
			$outer_notice_sn=$payment_notice['notice_sn'];
			require_once APP_ROOT_PATH."system/libs/cart.php";
		   $rs = payment_paid($payment_notice_id,$outer_notice_sn);		
		    if ($rs)
		   {
